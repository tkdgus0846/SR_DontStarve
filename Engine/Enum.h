...
enum LAYERID { LAYER_PLAYER, LAYER_ENVIRONMENT, LAYER_MONSTER, LAYER_BULLET, LAYER_SKILL, LAYER_UI, LAYER_OBSTACLE, LAYER_CAMERA, LAYER_BOSS, LAYER_NPC, LAYER_ITEM, LAYER_END};
