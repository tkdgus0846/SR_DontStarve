...
enum LOADINGID { LOADING_STAGE, LOADING_STAGE2, LOADING_STAGE3, LOADING_STAGE4, LOADING_EDITSTAGE, LOADING_BOSS, LOADING_END };
...
enum ANIMSTATE {
	...
	ANIM_IDLE, ANIM_WALK, ANIM_RUN, ANIM_JUMP, ANIM_ATTACK, ANIM_ATTACK2, ANIM_ATTACK3, ANIM_DAMAGED, ANIM_DAMAGED2, ANIM_DAMAGED3, ANIM_FLY, ANIM_SHOT, ANIM_SIDE, ANIM_TOP, ANIM_FACE, ANIM_BACK, ANIM_DEAD, ANIM_END};
...
enum CHANNELID { SOUND_BGM, SOUND_BGM_SHOP, SOUND_BGM_FIELD, SOUND_BGM_BOSS, SOUND_BGM_END, SOUND_EFFECT, SOUND_LOOT, SOUND_ENVIRONMENT, SOUND_ENEMY, SOUND_ENEMY_BULLET, SOUND_OBJ, SOUND_SUSTAIN, SOUND_EJECT, MAXCHANNEL };
...
namespace Engine
{
	...
	enum RENDERID { RENDER_PRIORITY, RENDER_ALPHA, RENDER_NONALPHA, RENDER_UI, RENDER_PRE_ALPHA_UI, RENDER_ALPHA_UI, RENDER_AFTER_ALPHA_UI,RENDER_FINAL_UI, RENDER_Scene_UI, RENDER_END };
