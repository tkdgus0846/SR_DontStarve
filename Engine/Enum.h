...
enum CHANNELID { SOUND_BGM, SOUND_BGM_SHOP, SOUND_BGM_FIELD, SOUND_BGM_BOSS, SOUND_BGM_END, SOUND_EFFECT, SOUND_LOOT, SOUND_ENVIRONMENT, SOUND_ENEMY, SOUND_OBJ, SOUND_SUSTAIN, SOUND_EJECT, MAXCHANNEL };
