...
namespace Engine
{
	...
	enum RENDERID { RENDER_PRIORITY, RENDER_ALPHA, RENDER_NONALPHA, RENDER_UI, RENDER_PRE_ALPHA_UI, RENDER_ALPHA_UI, RENDER_AFTER_ALPHA_UI,RENDER_FINAL_UI, RENDER_END };
