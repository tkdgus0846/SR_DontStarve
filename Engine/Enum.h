...
enum CHANNELID { SOUND_BGM, SOUND_BGM_SHOP, SOUND_BGM_FIELD1, SOUND_BGM_END, SOUND_EFFECT, SOUND_ENVIRONMENT, SOUND_ENEMY, SOUND_OBJ, SOUND_SUSTAIN, SOUND_EJECT, MAXCHANNEL };
