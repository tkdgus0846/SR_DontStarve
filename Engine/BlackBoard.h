...
public:
	HRESULT Add_Type(IN const _tchar* pTypename, IN const _int& iType);
	HRESULT Add_Type(IN const _tchar* pTypename, IN const _float& fType);
	HRESULT Add_Type(IN const _tchar* pTypename, IN const _bool& bType);
	HRESULT Add_Type(IN const _tchar* pTypename, IN const _vec3& vType);
