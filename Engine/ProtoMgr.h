...
public:
	...
	// Collider 클론용
	class CComponent*	Clone_Proto(const _tchar * pProtoTag, class CGameObject* pGameObject, COLGROUP eColGroup, const _vec3& boundSize = {2.f,2.f,2.f}, COLTYPE colType = COL_STATIC);
