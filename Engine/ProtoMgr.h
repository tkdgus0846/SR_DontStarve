...
public:
	...
	// Particle 클론용
	class CComponent*	Clone_Proto(const _tchar * pProtoTag, class CGameObject* pGameObject, const _int& particleNums, const _vec3& origin, const _vec3& boundSize = { 2.f,2.f,2.f });
